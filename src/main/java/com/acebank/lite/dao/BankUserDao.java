...
public interface BankUserDao {
    ...
    Optional<Integer> getAccountNoByEmail(String email) throws SQLException;

    boolean upsertPasswordResetOtp(String email, int accountNo, String otpHash, Timestamp expiresAt) throws SQLException;

    Optional<PasswordResetOtp> getPasswordResetOtp(String email) throws SQLException;

    boolean incrementPasswordResetAttempts(String email) throws SQLException;

    boolean markPasswordResetUsed(String email) throws SQLException;

    boolean setPasswordByAccountNo(int accountNo, String newPasswordHash) throws SQLException;
